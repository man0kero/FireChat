...
public class UserListActivity extends AppCompatActivity {
    ...
    private void attachUserDatabaseReferenceListener () {
        ...
        usersDatabaseReference = FirebaseDatabase.getInstance("https://awesomefirechat-16da6-default-rtdb.europe-west1.firebasedatabase.app/")
    ...
    private void buildRecyclerView () {
        ...
        userAdapter.setOnUserOnClickListener(new UserAdapter.OnUserClickListener() {
            @Override
